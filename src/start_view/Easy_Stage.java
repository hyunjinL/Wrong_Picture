...
class Easy_Panel extends JPanel implements MouseListener {
	Easy_1_1 pic_1_1 = new Easy_1_1();
	Easy_1_2 pic_1_2 = new Easy_1_2();
	Easy_2_1 pic_2_1 = new Easy_2_1();
	Easy_2_2 pic_2_2 = new Easy_2_2();
	Easy_3_1 pic_3_1 = new Easy_3_1();
	Easy_3_2 pic_3_2 = new Easy_3_2();
	Easy_4_1 pic_4_1 = new Easy_4_1();
	Easy_4_2 pic_4_2 = new Easy_4_2();
	Easy_5_1 pic_5_1 = new Easy_5_1();
	Easy_5_2 pic_5_2 = new Easy_5_2();
	...
	public Easy_Panel() {
		...
		points[0][1] = new Point(2, 1);
		points[0][2] = new Point(4, 3);
		points[0][3] = new Point(5, 3);
		points[0][4] = new Point(6, 6);
		points[1][0] = new Point(2, 4);
		points[1][1] = new Point(4, 5);
		points[1][2] = new Point(5, 4);
		points[1][3] = new Point(5, 7);
		points[1][4] = new Point(6, 0);
		points[2][0] = new Point(0, 7);
		points[2][1] = new Point(3, 7);
		points[2][2] = new Point(4, 0);
		points[2][3] = new Point(7, 1);
		points[2][4] = new Point(7, 2);
		points[3][0] = new Point(3, 6);
		points[3][1] = new Point(4, 5);
		points[3][2] = new Point(5, 6);
		points[3][3] = new Point(6, 1);
		points[3][4] = new Point(6, 6);
		points[4][0] = new Point(0, 6);
		points[4][1] = new Point(2, 2);
		points[4][2] = new Point(3, 1);
		points[4][3] = new Point(5, 5);
		points[4][4] = new Point(5, 7);
		...
		hint_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(Hint_Count > 0)
				{
					...
					c2.setBounds(rect_point[points[Stage_Count-1][temp].x][points[Stage_Count-1][temp].y].x, 
							rect_point[points[Stage_Count-1][temp].x][points[Stage_Count-1][temp].y].y, 64, 75);
