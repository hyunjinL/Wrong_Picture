...
import start_view.Normal_Panel.MyTimerTask;

class Hard_Panel extends JPanel implements MouseListener {
	Hard_1_1 pic_1_1 = new Hard_1_1();
	Hard_1_2 pic_1_2 = new Hard_1_2();
	Hard_2_1 pic_2_1 = new Hard_2_1();
	Hard_2_2 pic_2_2 = new Hard_2_2();
	Hard_3_1 pic_3_1 = new Hard_3_1();
	Hard_3_2 pic_3_2 = new Hard_3_2();
	Hard_4_1 pic_4_1 = new Hard_4_1();
	Hard_4_2 pic_4_2 = new Hard_4_2();
	Hard_5_1 pic_5_1 = new Hard_5_1();
	Hard_5_2 pic_5_2 = new Hard_5_2();
	...
	public JPanel Hard_Rect = new JPanel();
	...
	public Hard_Panel() {
		...
		points[0][2] = new Point(4, 3);
		points[0][3] = new Point(7, 0);
		points[0][4] = new Point(7, 5);
		points[1][0] = new Point(3, 4);
		points[1][1] = new Point(5, 0);
		points[1][2] = new Point(5, 2);
		points[1][3] = new Point(5, 5);
		points[1][4] = new Point(7, 7);
		points[2][0] = new Point(0, 4);
		points[2][1] = new Point(3, 4);
		points[2][2] = new Point(3, 5);
		points[2][3] = new Point(5, 1);
		points[2][4] = new Point(5, 6);
		points[3][0] = new Point(0, 2);
		points[3][1] = new Point(1, 5);
		points[3][2] = new Point(3, 3);
		points[3][3] = new Point(4, 0);
		points[3][4] = new Point(6, 5);
		points[4][0] = new Point(0, 2);
		points[4][1] = new Point(4, 4);
		points[4][2] = new Point(6, 0);
		points[4][3] = new Point(6, 3);
		points[4][4] = new Point(6, 5);
		...
		Hard_Rect.setBackground(Color.MAGENTA);
...
// cardLayout controls
		...
		Hard_Rect.setBounds(-999, -999, 512, 300);
		...
		timer_btn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				{
					if(Main_Time / 10000 == 6)
					{
						t7.setBounds(-256, -664, 256, 64);
						t8.setBounds(256, 664, 256, 64);
					}
	...
	public void mouseClicked(MouseEvent e){
		...
		if((check_x != -1) && (check_y != -1))
		{
			if(check_arr[Stage_Count-1][check_x][check_y] == 0)
			{
				...
				if(flag == 1)
				{
					c_check1.setBounds(rect_point[check_x][check_y].x, rect_point[check_x][check_y].y, 64, 75);
					c_check2.setBounds(rect_point[-(check_x-7)][-(check_y-7)].x, rect_point[-(check_x-7)][-(check_y-7)].y, 64, 75);
				}
				else if(flag == 2)
				{
					c_check2.setBounds(rect_point[check_x][check_y].x, rect_point[check_x][check_y].y, 64, 75);
					c_check1.setBounds(rect_point[-(check_x-7)][-(check_y-7)].x, rect_point[-(check_x-7)][-(check_y-7)].y, 64, 75);
				}
	...
	class MyTimerTask extends TimerTask {
		public void run() {
			...
			if(Main_Time / 10000 == 8)
			{
				Hard_Rect.setBounds(0, 0, 512, 300);
				t8.setBounds(256, 664, 256, 64);
				rect_timer();
			}
			else if(Main_Time / 10000 == 7)
			{
				t8.setBounds(-256, -664, 256, 64);
				t7.setBounds(256, 664, 256, 64);
			}
			...
			{
				Hard_Rect.setBounds(512, 0, 512, 300);
				t7.setBounds(-256, -664, 256, 64);
				t6.setBounds(256, 664, 256, 64);
				rect_timer();
			}
			...
			{
				Hard_Rect.setBounds(0, 300, 512, 300);
				t5.setBounds(-256, -664, 256, 64);
				t4.setBounds(256, 664, 256, 64);
				rect_timer();
			}
			...
			{
				Hard_Rect.setBounds(512, 300, 512, 300);
				t3.setBounds(-256, -664, 256, 64);
				t2.setBounds(256, 664, 256, 64);
				rect_timer();
			}
	...
	public void rect_timer() {
		Timer rect_timer = new Timer(true);
		TimerTask rect_task = new TimerTask() {
			public void run() {
				Hard_Rect.setBounds(-999, -999, 512, 300);
			}
		};
		rect_timer.schedule(rect_task, 5000);
	}
